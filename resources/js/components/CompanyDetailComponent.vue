...
<!--                                    </span>-->
                        ...
                        <tr class="h_39">
                            ...
                            <td class="text_1">
                                <div  v-if="user_role==10 || user_role==5" class="p_left6">                                
                                    <div class="ds_flex">
                                        ...
                                        <input id="user_id" name="user_id" type="text" v-model="new_branches['lid']" list="company_users">
                                        <datalist id="company_users">
                                            <option v-for="(branch, index) in branches">{{ branch['login_id'] }}</option>
                                        </datalist>
                                    </div>                                
                                </div>
                                <div  v-if="user_role < 5" class="p_left6">                                
                                    <div class="ds_flex" v-model="new_branches['lid']">
                                        <!--<select v-model="company.user_id" class="w_110">
                                            <option v-for="(branch, index) in branches" v-bind:value="branch['id']" :selected="company.user_id == branch.id">{{ branch['login_id'] }}</option>
                                        </select>-->
                                        <!--"new_branches[company.user_id]['login_id']" v-on:input="sourceChanged" -->
                                        <input id="user_id" name="user_id" type="text" v-model="new_branches['lid']" disabled>                                        
                                    </div>                                
                                </div>
                            </td>     
                        </tr>           
    ...
    export default {
        ...
        methods: {
            ...
            update: function () {                
                ...
                this.company.user_id = document.getElementById("user_id").value;
